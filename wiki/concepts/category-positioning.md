...
## Definition
Category positioning is how a company defines its competitive context: what category it belongs to, whether it's creating a new one, and how it differentiates from the alternatives buyers already know. Strata's approach emphasizes owning the frame, not just the features.

## How It Works
Strata identifies one of three positioning stances for each client:

1. **Category creation** -- define a new category and become its first leader.
2. **Category redefinition** -- take an existing category and reframe what it means.
3. **Head-to-head competition** -- compete directly but with a clear differentiator.

The positioning stance drives everything: the hero problem framing, the POV opening, the competitive differentiation section, and even the product naming.
...
|--------|-------------------|----------------|
| A home services AI platform (Series B) | vs. point solutions and vs. human teams/call centers | End-to-end lifecycle coverage, not just voice AI. Human-in-the-loop. Enterprise-ready. |
| A game development platform (enterprise) | vs. competing 3D editors, vs. ad network competitors | Full-stack ecosystem (create + deploy + grow), lower barrier to entry, largest dev community. |
| An employee recognition platform (Series B) | vs. transactional gift cards, vs. other platforms | Curated global marketplace, customizable campaigns, no sunk cost (pay on redemption). |
...
- [[pov-opening-strategies]] — "reframe the market" is both an opening strategy and a category play
- [[messaging-hierarchy]] — category positioning governs the top-level tagline and elevator pitch
