# Problem Pillar Formula

_Cross-client analysis of how pain pillars decompose the hero problem, with universal patterns and application guidance_

## Overview

Every Strata messaging framework decomposes the hero problem into three pain pillars -- sub-problems that break a single systemic challenge into distinct, addressable dimensions. This article analyzes the pillar construction across all 10 completed engagements to identify structural patterns, recurring archetypes, sequencing logic, mirroring relationships, and a universal formula.

---

## The Complete Pillar Map
...
### Every pillar is a mini hero problem
Each pillar replicates the hero problem's three-layer structure at a lower level:
- **Pain statement** -- a named sub-problem
- **Causes** -- structural reasons this sub-problem exists (typically 2-3)
- **Consequences** -- specific costs the buyer tolerates

This is fractal: the hero problem decomposes into three pillars, each of which has its own cause-consequence logic. The strongest frameworks (a headcount management platform (Series B), a home services AI platform (Series B), a customer AI agent platform (Series A), a legal AI platform (Series B)) maintain this structure rigorously in every pillar.

### Three is the magic number
9 of 10 clients use exactly three pillars. A healthcare practice management platform (Series A) is the sole exception with four. Three pillars create a rhythm that's easy to remember, present, and sell with. Two feels incomplete; four loses focus. The 3-pillar constraint forces the team to make hard choices about what matters most -- which is itself a strategic act.

### Each pillar has its own cause-consequence stack
The raw frameworks show a consistent internal structure:

```
Pain Pillar Name (2-5 words)
    |
    Pain Statement (one sentence describing the sub-problem)
    |
    Causes (2-3 structural reasons this exists)
    |
...
## 2. Sequencing Logic: The Value Chain Progression

The three pillars are not randomly ordered. Across 8 of 10 clients, the pillars follow a **value chain progression** -- moving from upstream inputs to downstream outcomes:

### The Pattern: Input → Process → Output

| Client | Pillar 1 (Input/Capacity) | Pillar 2 (Process/Quality) | Pillar 3 (Outcome/Value) |
|--------|--------------------------|---------------------------|--------------------------|
| A customer AI agent platform (Series A) | Can't reach all customers (coverage) | Bad experience when you do (quality) | Don't realize value (outcome) |
| A headcount management platform (Series B) | Data is bad (input quality) | Process is broken (governance) | Time is wasted (productivity) |
| An industrial 3D platform (enterprise) | Can't create (input access) | Can't collaborate (process) | Can't see what's built (visibility) |
| A game development platform (enterprise) | Dev overhead (input cost) | Live ops demands (process) | Growth/monetization difficulty (outcome) |
| An AI-native law firm | Can't keep up (throughput) | No time for strategy (allocation) | Perceived as cost center (outcome) |
| A search marketing platform (enterprise) | No bandwidth (capacity) | Can't make sense of data (process) | Can't get organizational buy-in (outcome) |
| An employee recognition platform (Series B) | No strategy (planning) | Operations are manual (execution) | Gifts don't land (impact) |
| A legal AI platform (Series B) CLO | Business bottleneck (throughput) | Escalating spend (cost) | Team overwhelmed (capacity) |

**Why it works:** The value chain progression mirrors how the buyer experiences the problem. They first feel the input constraint (not enough resources, bad data, no access), then encounter the process failure (broken workflows, inconsistent quality), and finally suffer the outcome failure (unrealized value, wasted spend, lost opportunity). This sequencing builds a logical argument: the inputs are broken → so the process is broken → so the outcomes are broken.

**A home services AI platform (Series B) is the notable variant.** Its sequence is revenue capture (input) → quality (process) → staffing (capacity) -- the third pillar loops back to an input problem (people). This works because for owner-operators, staffing *is* the output problem: you can't scale without solving the people constraint.

---

## 3. The Five Pillar Archetypes

Five recurring archetypes emerge across the 30+ pillars in the corpus:

### A. The Capacity Pillar -- "We can't do enough"
The most common archetype, appearing in **8 of 10 clients**. Names a volume, coverage, or throughput constraint.
...
### B. The Quality Pillar -- "When we do act, it's inconsistent or broken"
Appears in **6 of 10 clients**. Names a consistency, process, or experience failure.
...
### C. The Outcome Pillar -- "We're not achieving what we should"
Appears in **5 of 10 clients**. Names a value realization, strategic, or perception failure.
...
### D. The Visibility Pillar -- "We can't see what's happening"
Appears in **3 of 10 clients**. Names a data, transparency, or information failure.
...
### E. The Cost Pillar -- "We're spending too much for what we get"
Appears in **3 of 10 clients**. Names a financial waste, inefficiency, or time-sink failure.
...
| Archetype | Appearances | Most common position |
|-----------|------------|---------------------|
| Capacity | 8 of 10 clients | Pillar 1 (input) |
| Quality | 6 of 10 | Pillar 2 (process) |
| Outcome | 5 of 10 | Pillar 3 (output) |
| Visibility | 3 of 10 | Pillar 1 (input) |
| Cost | 3 of 10 | Pillar 2 or 3 |

---

## 4. Hero Problem to Pillar Relationship

The pillars don't just "support" the hero problem -- they **decompose** it along non-overlapping dimensions. The hero problem is the compression; the pillars are the expansion.

### The decomposition rule
**Each pillar must address a different dimension of the hero problem. No two pillars can describe the same type of failure.**

Testing this against the corpus:

**Strong decomposition (no overlap):**
- **A headcount management platform (Series B):** Data (information) + Control (governance) + Time (productivity) -- three completely distinct dimensions
- **A home services AI platform (Series B):** Revenue capture (demand) + CX quality (experience) + Staffing (supply) -- three distinct operational dimensions
- **A customer AI agent platform (Series A):** Coverage (reach) + Experience (quality) + Value (outcomes) -- clean customer journey decomposition
...
## 5. The Mirroring Pattern: Pain → Value → Outcome

Every client in the corpus maps pain pillars 1:1 to value pillars and outcome pillars. This is the most consistent structural pattern in the entire wiki.

### The inversion rule
**Each value pillar is the exact inversion of its corresponding pain pillar.** The pain names the broken state; the value names the solved state.

| Client | Pain Pillar | Value Pillar | Inversion Type |
|--------|------------|-------------|----------------|
| A headcount management platform (Series B) | Untrusted data | Real-time visibility | Negation |
| A headcount management platform (Series B) | Lack of control | Unified process | Negation |
| A headcount management platform (Series B) | Wasted time | Automated workflows | Negation |
| A home services AI platform (Series B) | Underfilled job boards | Book more jobs | Aspiration |
| A home services AI platform (Series B) | Inconsistent CX | Deliver exceptional experiences | Aspiration |
| A home services AI platform (Series B) | Staffing challenges | Scale your front office | Aspiration |
| A customer AI agent platform (Series A) | Limited coverage | Infinite capacity to serve | Aspiration |
| A customer AI agent platform (Series A) | Terrible CX | Single point of contact | Mechanism |
| A customer AI agent platform (Series A) | Unrealized value | Complete context on every customer | Mechanism |
| A legal AI platform (Series B) CLO | Bottleneck to business | Stop the toil | Negation |
| A legal AI platform (Series B) CLO | Escalating spend | Deliver greater business value | Aspiration |
| A legal AI platform (Series B) CLO | Overloaded team | Supercharge your network | Aspiration |
| An industrial 3D platform (enterprise) | Creation bottlenecked | Enable more people to create in 3D | Aspiration |
| An industrial 3D platform (enterprise) | Collaboration barriers | One place to collaborate in 3D | Mechanism |
| An industrial 3D platform (enterprise) | Can't see what's built | Immersive experiences for everyone | Aspiration |
...
### Tier 1: Clean decomposition, clean mirroring, clean naming

| Client | Why it's strong |
|--------|----------------|
...
## 7. The Universal Pillar Construction Formula

### The Formula

```
Three pillars, each addressing a different dimension of the hero problem,
sequenced from upstream to downstream (input → process → outcome),
each containing its own cause-consequence stack,
each mapping 1:1 to a value pillar via inversion.
```

### Step-by-step application guide

**Step 1: Identify the dimensions.**
Take the hero problem and ask: what are the 3 non-overlapping dimensions of this problem? Use the archetype menu as a starting point:

| Dimension | Question it answers |
|-----------|-------------------|
| Capacity | "Can we do enough?" |
| Quality | "Is it good when we do it?" |
| Visibility | "Can we see what's happening?" |
| Cost | "What are we wasting?" |
| Outcome | "Are we achieving what we should?" |

Most pillar sets use 3 of these 5. The most common combination is **Capacity + Quality + Outcome**.

**Step 2: Sequence them.**
Order the pillars from upstream to downstream: the input/capacity problem first, the process/quality problem second, the outcome/value problem third. This creates a logical flow: "We can't do enough → and when we do, it's broken → so we're not getting results."

**Step 3: Build the cause-consequence stack for each.**
Each pillar needs:
- A pain statement (one sentence)
- 2-3 structural causes (why this dimension is failing)
- 2-3 negative consequences (what it costs)
...
1. **The overlap test:** Can you clearly explain how Pillar 2 is different from Pillar 1? If you have to work hard to differentiate them, they overlap.
2. **The completeness test:** Do the three pillars, combined, fully account for the hero problem? If someone described all three pillars to a buyer, would the buyer say "yes, that's the whole problem"?
3. **The independence test:** Could you solve Pillar 1 without solving Pillar 2? If the pillars are truly independent dimensions, solving one shouldn't automatically solve another.
4. **The mirror test:** Does each pain pillar invert cleanly to a value pillar? If you can't write the value pillar, the pain pillar may be too vague or too complex.

---

## Naming Conventions

### Pillar naming styles across the corpus
...
## Related Concepts
- [[concepts/messaging-hierarchy]] -- the structural home of pain pillars in the Strata architecture
- [[concepts/hero-problem-framing]] -- the hero problem determines how the pillars decompose
- [[engagements/hero-problem-formula]] -- the hero problem formula that the pillars expand
- [[concepts/proof-point-patterns]] -- proof points validate each pillar's consequences

## Related Clients
- A headcount management platform (Series B) -- Tier 1 model (tightest pillar set)
- A home services AI platform (Series B) -- Tier 1 model (strongest cause-consequence stacks)
