...
## Definition
Customer language capture is the practice of preserving the exact words, phrases, and metaphors that buyers and customers use to describe their problems, desired outcomes, and decision criteria. Strata treats these phrases as raw material for messaging, not data to be summarized away. The goal is to ensure that messaging speaks the buyer's language, not the company's.

## How It Works
1. **Stakeholder interviews.** Strata conducts structured interviews with executives, customers, and internal teams using a consistent interview guide (see `raw/frameworks/interview-guide-ceo-template.md`). Key questions probe for unfiltered descriptions of problems, competition, and vision.
2. **Listen for sticky phrases.** During interviews, certain phrases stand out because they compress a complex idea into memorable language. These become candidates for hero problem names, pillar labels, or tagline language.
3. **Preserve in quotes.** The messaging framework preserves notable customer language in direct quotes rather than paraphrasing.
4. **Test in the framework.** The captured language is tested against the 3-pillar structure: does it map cleanly to a pain pillar, a cause, or a consequence?
...
- **Personal & Vision:** Why did you start/join? What's the big problem?
- **Industry & Competition:** Market opportunity, disruption targets, emerging trends
- **Audience & Story:** Current story, is it landing, where is the misalignment?
- **Strategy & Roadmap:** 2-year vision, what hasn't worked in GTM, internal/external challenges
- **Pre-Workshop:** Executive alignment, workshop goals, pitch deck request
...
## Related Concepts
- [[hero-problem-framing]] — hero problem names often come directly from captured customer language
- [[icp-signal-patterns]] — ICP definition is validated by whether the language resonates with the target buyer
- [[messaging-hierarchy]] — customer language influences every level, especially taglines and elevator pitches
